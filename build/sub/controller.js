...
var userAdd = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, service_1.addUserToDatabase(req.body.name, req.body.email, req.body.password)];
            case 1:
                _a.sent();
...
var ngoAdd = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, service_1.addNgoToDatabase(req.body.name, req.body.email, req.body.phone, req.body.address, req.body.time)];
            case 1:
                _a.sent();
                res.json({ success: true, message: "data added" });
                return [3 /*break*/, 3];
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var checklogin, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, service_1.loginDatabase(req.body.email, req.body.password)];
            case 1:
                checklogin = _a.sent();
...
var contactus = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, service_1.contactUsToDatabase(req.body.name, req.body.email, req.body.number, req.body.message)];
            case 1:
                _a.sent();
                res.json({
                    success: true,
